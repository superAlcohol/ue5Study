...
AABCharacterPlayer::AABCharacterPlayer()
{
	...
	{
		ChangeControlAction = InputChangeInputControlRef.Object;
	}
...
void AABCharacterPlayer::SetCharacterControl(ECharacterControlType NewCharacterControlType)
{
	...
	if (UEnhancedInputLocalPlayerSubsystem* Subsystem = ULocalPlayer::GetSubsystem<UEnhancedInputLocalPlayerSubsystem>(PlayerController->GetLocalPlayer() ))
	{
		...
		UInputMappingContext* NewMappingContext = NewCharacterControl->InputMappoingContext;
...
void AABCharacterPlayer::ShoulderMove(const FInputActionValue& Value)
{
	...
	AddMovementInput(RightDirction, MovementVector.Y);
}
...
void AABCharacterPlayer::QuaterMove(const FInputActionValue& Value)
{
	...
	{
		MovementVectorSizeSquared = FMath::Sqrt(MovementVectorSizeSquared);
	}
