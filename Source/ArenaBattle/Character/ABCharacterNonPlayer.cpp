...
void AABCharacterNonPlayer::SetDead()
{
	...
	// 타이머 
	FTimerHandle DeadTimerHandle; // 핸들
...
float AABCharacterNonPlayer::GetAIPatrollRadius()
{
	return 800.0f;
}
...
{
	return CharcterStat->GetTotalStat().AttackRange + CharcterStat->GetAttackRadius() * 2;
}
